...
Synchronization automatically requests all remote resources that have been changed (including new and deleted records) since the last successful synchronization.
You may need to override the changed_remotes_since class method in your model to match your host's REST API.

==== Manual synchronization

See HasRemote::Synchronizable for more information on the available methods for triggering synchronization manually.
